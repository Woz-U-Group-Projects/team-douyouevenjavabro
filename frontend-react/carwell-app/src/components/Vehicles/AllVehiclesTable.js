...
class Vehicles extends React.Component {
  ...
  callVehicles = () => {
    vehiclesApi.fetchValues().then(response => {
      console.log("Result for GET all vehicles: ", response);
      this.setState(() => {
        return {
          vehicles: response
        };
      });
      // console.log("All vehicles data: ", this.state.vehicles);
    });
  };
          ...
          <TableBody>
            {this.state.vehicles.map(vehicle => (
              ...
              <CustomTableCell>{vehicle.make}</CustomTableCell>
                ...
                <CustomTableCell>{vehicle.milesAtRegistration}</CustomTableCell>
